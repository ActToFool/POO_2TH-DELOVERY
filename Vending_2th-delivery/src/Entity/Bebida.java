...
public abstract class Bebida extends Producto{
    ...
    public Bebida(int litros, float valorLitro, String codigo, int UnidadesDisponibles, HashMap<String, Adicional> adicionalesProducto, ArrayList<Producto> obsequios) {
